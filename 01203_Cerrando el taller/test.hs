describe "hacerService" $ do
  ...
  it "hacerService (Auto \"ABC123\" 20 30) [(\(Auto p n t) -> Auto p n (t+20)), cargarTanque 15, enchularPatente \"PDP\"] == (Auto \"PDP123\" 35 50)" $ do
    hacerService (Auto \"ABC123\" 20 30) [(\(Auto p n t) -> Auto p n (t+20)), cargarTanque 15, enchularPatente "PDP"] `shouldBe` (Auto "PDP123" 35 50)